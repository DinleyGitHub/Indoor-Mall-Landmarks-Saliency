function [fitness,fitness_outputs]=cal_fitness(data,predict_data)
...
for j=1:size(data,1)
    ...
    fitness_one=NDCG(rank_outputs,one_rank);
    fitness_outputs(1,j)=fitness_one;
end
fitness=mean(fitness_outputs);
end